...
case $tmpTARGET in
  ...
  debiandemu|debianctmu) TARGETDDURL=${IMGMIRROR/xxxxxx/inst}"/_build/devdeskos/binary$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n -arm64 || echo -n -amd64)/tarball"
